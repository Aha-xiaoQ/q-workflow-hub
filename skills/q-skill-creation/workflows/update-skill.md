...
7. Ask an option-style question only when a consequential unresolved tradeoff changes the requested outcome or authority. Infer routine reversible choices from available context and proceed. If a question is necessary, prepare concrete alternatives and continue independent authorized work while waiting.
