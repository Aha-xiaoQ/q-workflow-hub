...
## Personalize the workflow hub

The setup creates starter files under `personal-state/` for preferences,
role modes, help text, paused work, TODOs, and skill sync inventory. Edit those
private files when you want the workflow to become your own; do not put personal
state or credentials in the public starter repo.
